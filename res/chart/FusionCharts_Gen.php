...
/*
   ...
   *  Version: 1.0.1 (11 December 2013) [ Fix PHP Short Tag, Function addDatasetsFromDatabase
...
##------------ PRIVATE FUNCTIONS ----------------------------------------------------------------
  ...
  ### ----- Pupulate Color and Chart SWF array  ------ ------- ---------------------
	 ...
	 function colorInit(){
		...
		$this->arr_FCColors[] = "005ED6";

		$this->arr_FCColors[] = "9D050D";
