 ...
 * Version 1.2.3F ( 22 November 2013) - Specialized for FusionChartsFREE 
 * 					Checking Flash Version >=6 and added updateChartXML() for FREE Charts.
 * Version: 1.2.3 (1st September, 2013) - Added Fix for % and & characters, scaled dimensions, fixes in to properly handling of double quotes and single quotes in setDataXML() function.
 * Version: 1.2.2 (10th July, 2013) - Added Fix for % scaled dimensions, fixes in setDataXML() and setDataURL() functions
